...
const HeaderLayout = ({
  ...
  return (
    <header
      className="fixed flex flex-row bg-white w-full max-w-[39rem] h-[4.8rem] items-center justify-between px-[1.6rem] border-[0.1rem] border-t-none border-solid border-grey-300 z-10"
      {...rest}
    >
      {children}
    </header>
